...
class VideoAssembler:
    ...
    def assemble(self, image_path, voice_path, output_path, subtitles=None, progress_callback=None):
        ...
        if progress_callback:
            progress_callback(5, 'Bắt đầu ghép video bằng FFmpeg…')
        ...
        for raw in process.stdout or []:
            ...
            if line.startswith('out_time_ms='):
                if progress_callback:
                    progress_callback(75, 'FFmpeg đang ghi khung hình và audio…')
        ...
        if progress_callback:
            progress_callback(100, f'Đã tạo video: {output_path}')
